const meatRecipes = [
  // MEAT OPTIONS
  {
    ...
    description:
      "Elevate your Christmas celebration with this succulent prime rib, expertly crusted with a blend of aromatic herbs and spices. Slow-roasted to perfection, each slice promises a juicy and flavorful experience that will leave your guests craving seconds. Accompanied by a rich red wine reduction and garlic-infused mashed potatoes, this prime rib extravaganza is the epitome of holiday indulgence.",
    image: "",
    link: "",
    type: "",
    id: 1,
  },
  {
    ...
    description:
      "Unwrap the sweet and savory magic of Christmas with our Maple-Glazed Ham Harmony. This delectable ham is generously coated in a luscious maple glaze, creating a perfect balance of flavors. Served alongside caramelized sweet potatoes and green bean almondine, it's a symphony of tastes that will have your festive spirits singing.",
    image: "",
    link: "",
    type: "",
    id: 2,
